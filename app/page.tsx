...
export default function Home() {
  return (
    <main className="mx-auto flex w-[90%] max-w-7xl flex-col gap-4 py-4">
      ...
      <div className="flex flex-col gap-4 sm:flex-row">
        ...
        <div className="flex flex-1 flex-col gap-2 rounded-lg border p-4 text-sm">
          <div className="grid flex-1 grid-cols-[24,_repeat(7,_1fr)] gap-4">
            <ul className="flex w-fit flex-col justify-between text-end">
              <li>50k</li>
              <li>40k</li>
              <li>30k</li>
              <li>20k</li>
            ...
            {dailyTransactions.map((transaction) => (
              <div
                ...
                style={{
                  height:
                    (transaction.amount / maxTransactionAmount) * 100 + "%",
                }}
              >
          ...
          <ul className="grid grid-cols-[24,_repeat(7,_1fr)] justify-between gap-4 text-center">
            <li></li>
            <li>Sun</li>
            <li>Mon</li>
            <li>Tue</li>
